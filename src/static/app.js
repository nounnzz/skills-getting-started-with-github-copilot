      ...
      Object.entries(activities).forEach(([name, details]) => {
                ...
                .map(
                  (participant) => `
                    <div class="participant-row" data-participant="${participant}">
                      ...
                      <button class="participant-remove-btn" type="button" aria-label="Remove ${participant}" title="Remove ${participant}">
                        ✕
                      </button>
                    </div>
                  `
        ...
        activityCard.querySelectorAll(".participant-remove-btn").forEach((button) => {
          button.addEventListener("click", async () => {
            const participantEmail = button.parentElement.dataset.participant;
            try {
